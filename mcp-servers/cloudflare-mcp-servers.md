...
Full example output using the Workers Bindings MCP server can be found [here](https://blog.cloudflare.com/workers-bindings-mcp-server-example). <!-- Assuming this is a link -->
